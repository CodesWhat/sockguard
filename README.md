...
| **0.7.0** | Abuse controls — per-client token-bucket rate limits, burst budgets, concurrency caps, per-endpoint cost weighting for expensive Docker operations (priority/fairness is follow-up work) | 🛠️ in progress |
