...
| Supply chain (v1.x) | `egress-policy: block` with curated allow-lists on high-privilege release jobs; SBOM generation for binary release artifacts; digest-pinned scanner/test images |
