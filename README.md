...
| **Helm chart** | The chart's DaemonSet gained a pod-level `podSecurityContext` with a `supplementalGroups` placeholder, for granting the non-root container the Docker socket's host GID. |
