...
const file_github_com_moby_buildkit_api_services_control_control_proto_rawDesc = "" +
	...
	"\x06Status\x12\x1f.moby.buildkit.v1.StatusRequest\x1a .moby.buildkit.v1.StatusResponse0\x01BNZLgithub.com/codeswhat/sockguard/v2/app/internal/buildkitproto/control;controlb\x06proto3"
...
var file_github_com_moby_buildkit_api_services_control_control_proto_goTypes = []any{
	(*SolveRequest)(nil),          // 0: moby.buildkit.v1.SolveRequest
	(*CacheOptions)(nil),          // 1: moby.buildkit.v1.CacheOptions
	(*CacheOptionsEntry)(nil),     // 2: moby.buildkit.v1.CacheOptionsEntry
	(*SolveResponse)(nil),         // 3: moby.buildkit.v1.SolveResponse
	(*StatusRequest)(nil),         // 4: moby.buildkit.v1.StatusRequest
	(*StatusResponse)(nil),        // 5: moby.buildkit.v1.StatusResponse
	(*Vertex)(nil),                // 6: moby.buildkit.v1.Vertex
	(*VertexStatus)(nil),          // 7: moby.buildkit.v1.VertexStatus
	(*VertexLog)(nil),             // 8: moby.buildkit.v1.VertexLog
	(*VertexWarning)(nil),         // 9: moby.buildkit.v1.VertexWarning
	(*Exporter)(nil),              // 10: moby.buildkit.v1.Exporter
	nil,                           // 11: moby.buildkit.v1.SolveRequest.ExporterAttrsDeprecatedEntry
	nil,                           // 12: moby.buildkit.v1.SolveRequest.FrontendAttrsEntry
	nil,                           // 13: moby.buildkit.v1.SolveRequest.FrontendInputsEntry
	nil,                           // 14: moby.buildkit.v1.CacheOptions.ExportAttrsDeprecatedEntry
	nil,                           // 15: moby.buildkit.v1.CacheOptionsEntry.AttrsEntry
	nil,                           // 16: moby.buildkit.v1.SolveResponse.ExporterResponseEntry
	nil,                           // 17: moby.buildkit.v1.Exporter.AttrsEntry
	(*pb.Definition)(nil),         // 18: pb.Definition
	(*sourcepolicy.Policy)(nil),   // 19: moby.buildkit.v1.sourcepolicy.Policy
	(*timestamppb.Timestamp)(nil), // 20: google.protobuf.Timestamp
	(*pb.ProgressGroup)(nil),      // 21: pb.ProgressGroup
	(*pb.SourceInfo)(nil),         // 22: pb.SourceInfo
	(*pb.Range)(nil),              // 23: pb.Range
}
var file_github_com_moby_buildkit_api_services_control_control_proto_depIdxs = []int32{
	18, // 0: moby.buildkit.v1.SolveRequest.Definition:type_name -> pb.Definition
	11, // 1: moby.buildkit.v1.SolveRequest.ExporterAttrsDeprecated:type_name -> moby.buildkit.v1.SolveRequest.ExporterAttrsDeprecatedEntry
	12, // 2: moby.buildkit.v1.SolveRequest.FrontendAttrs:type_name -> moby.buildkit.v1.SolveRequest.FrontendAttrsEntry
	1,  // 3: moby.buildkit.v1.SolveRequest.Cache:type_name -> moby.buildkit.v1.CacheOptions
	13, // 4: moby.buildkit.v1.SolveRequest.FrontendInputs:type_name -> moby.buildkit.v1.SolveRequest.FrontendInputsEntry
	19, // 5: moby.buildkit.v1.SolveRequest.SourcePolicy:type_name -> moby.buildkit.v1.sourcepolicy.Policy
	10, // 6: moby.buildkit.v1.SolveRequest.Exporters:type_name -> moby.buildkit.v1.Exporter
	14, // 7: moby.buildkit.v1.CacheOptions.ExportAttrsDeprecated:type_name -> moby.buildkit.v1.CacheOptions.ExportAttrsDeprecatedEntry
	2,  // 8: moby.buildkit.v1.CacheOptions.Exports:type_name -> moby.buildkit.v1.CacheOptionsEntry
	2,  // 9: moby.buildkit.v1.CacheOptions.Imports:type_name -> moby.buildkit.v1.CacheOptionsEntry
	15, // 10: moby.buildkit.v1.CacheOptionsEntry.Attrs:type_name -> moby.buildkit.v1.CacheOptionsEntry.AttrsEntry
	16, // 11: moby.buildkit.v1.SolveResponse.ExporterResponse:type_name -> moby.buildkit.v1.SolveResponse.ExporterResponseEntry
	6,  // 12: moby.buildkit.v1.StatusResponse.vertexes:type_name -> moby.buildkit.v1.Vertex
	7,  // 13: moby.buildkit.v1.StatusResponse.statuses:type_name -> moby.buildkit.v1.VertexStatus
	8,  // 14: moby.buildkit.v1.StatusResponse.logs:type_name -> moby.buildkit.v1.VertexLog
	9,  // 15: moby.buildkit.v1.StatusResponse.warnings:type_name -> moby.buildkit.v1.VertexWarning
	20, // 16: moby.buildkit.v1.Vertex.started:type_name -> google.protobuf.Timestamp
	20, // 17: moby.buildkit.v1.Vertex.completed:type_name -> google.protobuf.Timestamp
	21, // 18: moby.buildkit.v1.Vertex.progressGroup:type_name -> pb.ProgressGroup
	20, // 19: moby.buildkit.v1.VertexStatus.timestamp:type_name -> google.protobuf.Timestamp
	20, // 20: moby.buildkit.v1.VertexStatus.started:type_name -> google.protobuf.Timestamp
	20, // 21: moby.buildkit.v1.VertexStatus.completed:type_name -> google.protobuf.Timestamp
	20, // 22: moby.buildkit.v1.VertexLog.timestamp:type_name -> google.protobuf.Timestamp
	22, // 23: moby.buildkit.v1.VertexWarning.info:type_name -> pb.SourceInfo
	23, // 24: moby.buildkit.v1.VertexWarning.ranges:type_name -> pb.Range
	17, // 25: moby.buildkit.v1.Exporter.Attrs:type_name -> moby.buildkit.v1.Exporter.AttrsEntry
	18, // 26: moby.buildkit.v1.SolveRequest.FrontendInputsEntry.value:type_name -> pb.Definition
	0,  // 27: moby.buildkit.v1.Control.Solve:input_type -> moby.buildkit.v1.SolveRequest
	4,  // 28: moby.buildkit.v1.Control.Status:input_type -> moby.buildkit.v1.StatusRequest
	3,  // 29: moby.buildkit.v1.Control.Solve:output_type -> moby.buildkit.v1.SolveResponse
	5,  // 30: moby.buildkit.v1.Control.Status:output_type -> moby.buildkit.v1.StatusResponse
