...
const file_github_com_moby_buildkit_session_secrets_secrets_proto_rawDesc = "" +
	...
	"\aSecrets\x12d\n" +
	"\tGetSecret\x12*.moby.buildkit.secrets.v1.GetSecretRequest\x1a+.moby.buildkit.secrets.v1.GetSecretResponseBNZLgithub.com/codeswhat/sockguard/v2/app/internal/buildkitproto/secrets;secretsb\x06proto3"
