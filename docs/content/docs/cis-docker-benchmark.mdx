...
|---|---|---|
| **2.6** | TLS authentication for Docker daemon | mTLS on the sockguard TCP listener (see [Configuration → mTLS](/docs/configuration#mtls)) replaces direct daemon TLS for in-cluster consumers |
