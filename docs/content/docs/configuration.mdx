...
| `SOCKGUARD_REQUEST_BODY_CONTAINER_CREATE_ALLOW_DEVICE_CGROUP_RULES`   | `request_body.container_create.allow_device_cgroup_rules` | `false` | Allow `HostConfig.DeviceCgroupRules` (raw cgroup device entries).                    |
