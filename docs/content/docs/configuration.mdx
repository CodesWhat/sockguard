...
| --- | --- | --- |
| `container_create` | `allow_privileged`, `allow_host_network`, `allow_host_pid`, `allow_host_ipc`, `allowed_bind_mounts`, `allow_all_devices`, `allowed_devices`, `allow_device_requests`, `allow_device_cgroup_rules` | Denies privileged containers, host network/PID/IPC namespaces, non-allowlisted bind sources, non-allowlisted device mappings, device requests, and device cgroup rules. |
