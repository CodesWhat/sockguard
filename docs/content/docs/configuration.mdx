...
| `SOCKGUARD_REQUEST_BODY_CONTAINER_REMOVE_ALLOW_REMOVE_LINKS`   | `request_body.container_remove.allow_remove_links`      | `false` | Allow Docker's legacy container-link removal mode.                           |
...
allowing force removal, anonymous-volume removal, and legacy link removal as
well as a bare delete. Move the rule to YAML and configure
