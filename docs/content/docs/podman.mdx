...
- Full body modeling for `play/kube`, `generate/kube`, and `kube/apply` —
  these stay behind the blind-write acknowledgment described above rather
  than getting a real inspector.
