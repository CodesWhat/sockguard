...
# Still denies /build. Docker API v1.53 deprecated /session and /grpc, so a
# future build preset must be validated against the current Compose/BuildKit
# transport and preserve fail-closed body/stream mediation.
