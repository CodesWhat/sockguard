...
```yaml
# Allows: container read (list, inspect, stats, changes, logs)
...
# Allows: network read, volume read, distribution, Swarm service reads
# Denies: exec, build, swarm writes, secrets, plugins, process-list top,
#         raw archive/export/attach streams
...
# flag to harden. /containers/*/top, /archive, /export, /attach stay denied.
