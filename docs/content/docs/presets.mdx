---
title: Presets
description: Ready-made sockguard configs for drydock, drydock with self-update, drydock with compose, drydock with build, Portwing, Portwing with exec, Portwing with compose, Portwing with build, Traefik, Portainer, Watchtower, Homepage, Homarr, Diun, Autoheal, GitHub Actions and GitLab runners, the CIS Docker Benchmark, and read-only dashboards.
---
