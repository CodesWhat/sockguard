...
These digest approvals currently apply to frontend-less raw-LLB Solves.
They do not approve Dockerfile RUN lines or third-party frontend images.
The Dockerfile FileSync guard and third-party frontend denial still apply.
