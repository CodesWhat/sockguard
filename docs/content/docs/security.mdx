...
| **Medium** | `POST /containers/{id}/update`, `POST /volumes/create`, `POST /networks/create`, `POST /networks/{id}/connect`, `POST /networks/{id}/disconnect`, `POST /libpod/networks/create`, `POST /libpod/networks/{name}/connect`, `POST /libpod/networks/{name}/disconnect`, `POST /secrets/create`, `POST /configs/create`, `DELETE /containers/{id}` |
