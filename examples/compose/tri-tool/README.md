...
To allowlist bind mounts for containers Portwing recreates, add host paths to `sockguard-with-exec.yaml` under `request_body.container_create.allowed_bind_mounts`. For the full bundled-preset list see the main README's [bundled presets](../../../README.md#bundled-presets-18) section.
