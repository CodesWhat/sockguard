...
export const features: Feature[] = [
  ...
  },
  {
    ...
    bg: "bg-blue-100 dark:bg-blue-900/50",
    description:
      "Declarative rules in YAML. Glob patterns for paths, first-match-wins evaluation, and 10 bundled workload presets (drydock, Traefik, Portainer, Watchtower, Homepage, Homarr, Diun, Autoheal, read-only, CIS Docker Benchmark) plus the default config.",
    category: "control",
  },
  {
    icon: ArrowRight,
