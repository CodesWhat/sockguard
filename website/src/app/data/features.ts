...
export const features: Feature[] = [
  ...
  },
  {
    ...
    bg: "bg-blue-100 dark:bg-blue-900/50",
    description:
      "We use declarative YAML rules with glob patterns, first-match-wins evaluation, and 22 bundled workload presets (drydock, drydock with self-update, drydock with compose, drydock with build, drydock with mediated build, Traefik, Portainer, Watchtower, Homepage, Homarr, Diun, Autoheal, read-only, Podman read-only, CIS Docker Benchmark, GitHub Actions self-hosted runner, GitLab Runner, Portwing, Portwing with exec, Portwing with compose, Portwing with build, Portwing with mediated build) plus the default config.",
    category: "control",
  },
  {
    icon: ArrowRight,
