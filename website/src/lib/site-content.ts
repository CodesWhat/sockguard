...
export const roadmap: Milestone[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "Security-pass fixes merged forward: fresh embedded-resource ownership checks, registry-push exfiltration gate, browser headers, and non-root/seccomp Helm defaults",
      "v1.5.0-rc.2 carries the post-rc.1 fixes and restarts the promotion soak",
