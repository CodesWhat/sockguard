...
export const roadmap: Milestone[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "allow_endpoint_config on network connect narrowed into per-field gates (allow_static_addressing, allow_link_local_ips, allow_mac_pinning, allow_gw_priority, allow_aliases), so benign endpoint settings no longer require also allowing static-IP/MAC address pinning",
    ],
  },
];
